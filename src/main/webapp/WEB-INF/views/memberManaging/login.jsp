...
<div class="container">
    <form class="form-signin" method="post" action="/member/loginCheck">
        ${js}
        ...
        <button class="btn btn-lg btn-block" type="buttuon" onclick="location.href = '/member/join'" id="list">회원가입</button>
    </form>
