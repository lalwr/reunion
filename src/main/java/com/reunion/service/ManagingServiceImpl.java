...
public class ManagingServiceImpl implements ManagingService {
    ...
    public void signUp(String id,String name,String password,String school) {
        ...
        member.setName(name);
        member.setRegDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.KOREA).format(date));
        member.setEditDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.KOREA).format(date));
    ...
    public void update(String memberId, String password,String school) {
        ...
        member.setEditDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
    ...
    @Override
    @Transactional
    public void profileUpdate(String memberId, MultipartFile file){
        Member member = memberDao.selectMember(memberId);
        ProfPicDTO profile = profPicDao.profileDetail(member.getNo());
...
//        cal.get(Calendar.MONTH) + 1; // 월은 0부터 시작
//        cal.get(Calendar.DAY_OF_MONTH);
        ...
        profile.setName(originFileName);
        profile.setTempName(saveFileName);
        profile.setFileSize(file.getSize());
        profile.setPath(dir);
        profile.setFormat(file.getContentType());
        profile.setRegDate(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.KOREA).format(new Date()));
        profPicDao.upload(profile);
